...
const AppointmentForm = ({
  userId,
  patientId, // Make patientId optional
  type,
  appointment,
  setOpen,
}: {
    ...
    try {
      if (type === "create" && patientId) {
        const appointmentData = {
          userId,
          patient: patientId, // Use patientId directly since it's optional now
          primaryPhysician: values.primaryPhysician,
          schedule: new Date(values.schedule),
          reason: values.reason ?? "",  // Ensure reason is always a string
